...
//     Poses<double> poses_t1(2, Pose<double>::Eye(/*dim=*/2));
//
//     edges.row(0) << 0, 1;
//     edges.row(1) << 0, 1;
//
...
//         vertices.topRows(2), edges.topRows(1), Pose<double>::Eye(/*dim=*/2),
//         /*velocity=*/Pose<double>::Eye(/*dim=*/2),
//         /*force=*/Pose<double>::Eye(/*dim=*/2), /*density=*/1.0,
//         /*is_dof_fixed=*/VectorXb::Eye(3), /*is_oriented=*/false,
//         /*group=*/0);
